...
-- Nome: variável "bullets"
-- Propriedade: implementação
-- Binding time: compile time
-- Explicação: A variável "bullets é criada no momento em que o código é compilado, assim alocando o espaço para ela na memória
...
-- Propriedade: implementação
-- Binding time: compile time
-- Explicação: A função é criada quando o código é compilado, alocando assim o espaço para ela na memória
...
-- Nome: variável "player.x"
-- Propriedade: endereço
-- Binding time:  run time
-- Explicação: O endereço da variável só é obtido quando o programa é executado
...
-- Nome: variável "canShoot"
-- Propriedade: valor
-- Binding time:  run time
-- Explicação: O valor só é obtido quando há a execução do programa
...
-- Explicação: Na escolha da linguagem foi atribuida a palavra "for" com o intuito de realizar o bloco de código especificado até que suas condições sejam cumpridas
